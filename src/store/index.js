...
export const fetchtDataByGenre = createAsyncThunk("netflix/moviesByGenres", async({genre,type}, thunkApi) => {
    const{
        netflix: { genres },
    } = thunkApi.getState();
...
const NetflixSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(fetchtDataByGenre.fulfilled, (state, action) => {
            state.movies = action.payload;
          });
    },
});
